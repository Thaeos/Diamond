...
**Address:** \`${diamond.address}\`  
**Community Rating:** ${diamond.communityRating.toFixed(2)}/10 ⭐  
...
function generateGraphVisualization(diamonds: DiamondNode[]): string {
  ...
  diamonds.forEach(diamond => {
    ...
    mermaid += `  ${diamond.id}["${diamond.name}<br/>${diamond.rarity}<br/>⭐${diamond.communityRating.toFixed(1)}"]:::${diamond.rarity.toLowerCase()}\n`;
  });
...
// Main function
async function main() {
  console.log('🌳 Generating Obsidian Diamond Tree...');
  ...
  console.log(`✅ Generated ${diamonds.length} Diamond nodes`);
  ...
  console.log(`✅ Generated ${diamonds.length} Obsidian notes`);
  ...
  console.log('✅ Generated graph visualization');
...
${diamonds.map(d => `- [[${d.id}]] - <span style="color: ${d.color}">${d.rarity}</span> - ⭐${d.communityRating.toFixed(1)}`).join('\n')}
...
`;
  ...
  console.log('✅ Generated DiamondTrading.sol');
  ...
  console.log('');
  console.log('='.repeat(70));
  console.log('✨ Obsidian Diamond Tree Generated!');
  console.log(`   Total Diamonds: ${diamonds.length}`);
  console.log(`   Obsidian Notes: ${diamonds.length}`);
  console.log(`   Graph Visualization: ✅`);
  console.log(`   Trading Contract: ✅`);
  console.log('');
  console.log('🌳 The "tree" is the link structure between Diamonds.');
